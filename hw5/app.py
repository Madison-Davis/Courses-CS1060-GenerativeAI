...
def generate_newyork_articles(company_data: CompanyFormation) -> BytesIO:
    ...
    # Set up the document - only this line is bold
    c.setFont("Helvetica-Bold", 14)
    c.drawCentredString(300, 750, "CERTIFICATE OF INCORPORATION")
    
    # Rest is regular font
    ...
    # FIRST: Company Name - not indented, not bold
    c.drawString(50, 650, "FIRST: The name of this corporation is:")
    c.drawString(70, 630, company_data.company_name)
    
    # SECOND: Purpose - not indented, not bold
    c.drawString(50, 590, "SECOND: The purpose of the corporation is to engage in any lawful act or activity for which")
    c.drawString(50, 575, "a corporation may be organized under the Business Corporation Law. The corporation is not")
    c.drawString(50, 560, "formed to engage in any act or activity requiring the consent or approval of any state official,")
    c.drawString(50, 545, "department, board, agency or other body without such consent or approval first being obtained.")
    
    # THIRD: County - not indented, not bold
    c.drawString(50, 505, "THIRD: The county, within this state, in which the office of the corporation is to be located")
    c.drawString(50, 490, "is: ALBANY COUNTY.")
    
    # FOURTH: Shares - not indented, not bold
    c.drawString(50, 450, "FOURTH: The corporation shall have authority to issue one class of shares consisting of")
    c.drawString(50, 435, "1,000 common shares with $0.01 par value per share.")
    
    # FIFTH: Secretary of State as Agent - not indented, not bold
    c.drawString(50, 395, "FIFTH: The Secretary of State is designated as agent of the corporation upon whom process")
    c.drawString(50, 380, "against the corporation may be served.")
    c.drawString(50, 365, "The post office address to which the Secretary of State shall mail a copy of any process")
    c.drawString(50, 350, "against the corporation served upon the Secretary of State by personal delivery is:")
    c.drawString(50, 330, "418 BROADWAY STE Y, ALBANY, ALBANY COUNTY, NY 12207")
    
    # Incorporator - title is bold, content is indented
    c.setFont("Helvetica", 11)
    c.drawString(50, 210, "Incorporator:")
    c.setFont("Helvetica", 11)
    c.drawString(70, 190, f"/s/ {company_data.incorporator_name}")
    c.drawString(70, 170, "418 BROADWAY STE Y, ALBANY, ALBANY COUNTY, NY 12207")
    
    # Filer's Name and Address - title is bold, content is indented
    c.setFont("Helvetica", 11)
...
def generate_newyork_llc_certificate(company_data: CompanyFormation) -> BytesIO:
    ...
    c.drawString(50, 530, "SECOND: The county, within this state, in which the office of the limited liability company is to be")
    c.drawString(50, 510, "located is: ALBANY COUNTY.")
    
    # Article Third - Secretary of State as Agent
    c.drawString(50, 410, "THIRD: The Secretary of State is designated as agent of the limited liability company upon whom")
    c.drawString(50, 390, "process against the limited liability company be served.")
    c.drawString(50, 370, "The post office address to which the Secretary of State shall mail a copy of any process against")
    c.drawString(50, 350, "the limited liability company upon the Secretary of State by personal delivery is:")
    c.drawString(50, 330, "418 BROADWAY STE Y, ALBANY, ALBANY COUNTY, NY 12207")
    
    # Organizer
    c.drawString(50, 210, "Organizer:")
    c.drawString(70, 190, f"/s/ {company_data.incorporator_name}")
    c.drawString(70, 170, "418 BROADWAY STE Y, ALBANY, ALBANY COUNTY, NY 12207")
